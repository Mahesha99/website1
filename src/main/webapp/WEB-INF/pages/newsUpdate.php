...
<head>
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="/news/src/main/webapp/WEB-INF/css/newsUpdate.css">
...
<!---------------------- form-------------------------------------->
    <tr>
		...
		$con = mysqli_connect("localhost","root","","newsdb");
				...
				$sql ="SELECT * FROM `newstbl` WHERE `newsID`='".$_GET['id']."'";
				$image="";
      ...
      <td> <form action="newsUpdate.php?id=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data">
  ...
  <tbody>
    <tr>
      ...
      <td width="199">
      <h1 align="center">UPDATE NEWS</h1></td>
      <td width="577">&nbsp;</td>
    </tr>
    <tr>
      <td height="20">&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>TOPIC</td>
      <td><input type="text" name="txtTopic" id="txtTopic" maxlength="50" value="<?php echo $row['topic'];?>"  required></td>
    </tr>
    <tr>
      <td height="124">&nbsp;</td>
      <td>NEWS DESCRIPTION</td>
      <td>
      					<textarea id="txtNews" name="txtNews" maxlength="500" required>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>LOCATION</td>
      <td><input type="text" name="txtLocation" id="txtLocation" value="<?php echo $row['location'];?>">
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
          ...
          Publish this
		   ...
		   if(!$con)
			...
			die("sorry,we are facing a technical issue");
				 ...
				 $sql = "UPDATE `newstbl` SET `email` = '".$_SESSION["email"]."', `topic` = '".$topic."', `description` = '".$des."',`imagepath` = '".$image."', `location` = '".$location."', `time` = '".$time."', `status` = '".$status."' WHERE `newstbl`.`newsID` = ".$_GET['id'].";";
