...
<!---------------------- form-------------------------------------->
    <tr>
      <td> <form action="addArt.php" method="post" enctype="multipart/form-data">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTopic" id="txtTopic" required></td>
    </tr>
    <tr>
      <td height="124">&nbsp;</td>
      <td><strong>FULL NAME</strong></td>
      <td><textarea id="txtFullname" name="txtFullname" required></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><strong>IMAGE</strong></td>
      <td><input type="file" name="fileImage" id="fileImage" required/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><strong>DATE</strong></td>
      <td><input type="text" name="txtDate" id="txtDate" required></td>
    </tr>
    <tr>
      <td height="84">&nbsp;</td>
        ...
        <strong>PUBLISH THIS</strong>
		   ...
		   if(!$con)
			...
			die("sorry,we are facing a technical issue");
		     ...
		     $sql = "INSERT INTO `arttbl` (`artID`, `email`, `fullName`, `date`, `topic`, `status`, `imagepath`) VALUES (NULL, '".$_SESSION["email"]."', '".$fullName."', '".$date."', '".$topic."', '".$status."', '".$image."');";
