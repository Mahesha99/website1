...
<head>
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="/news/src/main/webapp/WEB-INF/css/updateInfo.css">
    ...
    <tr>
     ...
     <?php
		...
		$con = mysqli_connect("localhost","root","","newsdb");
				...
				$sql ="SELECT * FROM `infotbl` WHERE `infoID`='".$_GET['id']."'";
				$image="";
      ...
      <td> <form action="updateInfo.php?id=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data">
		
		
		<table width="1096" height="588" border="0">
  <tbody>
    <tr>
      <td height="84" colspan="3"><h1 align="center">UPDATE INFORMATION</h1></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTopic" id="txtTopic" maxlength="30" value="<?php echo $row['topic'];?>"></td>
    </tr>
    <tr>
      <td height="124">&nbsp;</td>
      <td><strong>INFORMATION  DESCRIPTION</strong></td>
      <td><textarea id="txtInfo" name="txtInfo" maxlength="400"><?php echo $row['des'];?></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input type="text" name="txtLocation" id="txtLocation" value="<?php echo $row['location'];?>"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><strong>TIME</strong></td>
      <td><input type="text" name="txtTime" id="txtTime" value="<?php echo $row['time'];?>"></td>
    </tr>
    <tr>
      <td height="84">&nbsp;</td>
        ...
        <strong>PUBLISH THIS</strong>
        	<br>
			  ...
			  if(isset($_POST["btnSubmit"]))
			  {
				...
				{
   				$image = "informations/".basename($_FILES["fileImage"]["name"]);
		   ...
		   if(!$con)
			...
			die("sorry,we are facing a technical issue");
				 ...
				 $sql = "UPDATE `infotbl` SET `email` = '".$_SESSION["email"]."', `topic` = '".$topic."', `des` = '".$des."',`imagepath` = '".$image."', `location` = '".$location."', `time` = '".$time."', `status` = '".$status."' WHERE `infotbl`.`infoID` = ".$_GET['id'].";";
    ...
    <tr>
      <td height="68">&nbsp;</td>
      <td><input name="btnReset" type="reset" class="button" id="btnReset" value="Cancel"  onclick="window.location.href='/news/src/main/webapp/WEB-INF/pages/viewmyInfo.php'" /></td>
      <td><input name="btnSubmit" type="submit" class="button" id="btnSubmit" value="Update"   /></td>
    </tr>
  </tbody>
