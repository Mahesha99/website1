...
<head>
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="/news/src/main/webapp/WEB-INF/css/addInfo.css">
...
<!---------------------- form-------------------------------------->
    <tr>
      <td> <form action="addInfo.php" method="post" enctype="multipart/form-data">
		
		
		<table width="1096" height="588" border="0">
  <tbody>
    <tr>
      <td height="84" colspan="3"><h1 align="center">ADD INFORMATION</h1></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTopic" id="txtTopic" maxlength="30"></td>
    </tr>
    <tr>
      <td height="124">&nbsp;</td>
      <td><strong>INFORMATION  DESCRIPTION</strong></td>
      <td><textarea id="txtInfo" name="txtInfo" maxlength="400"></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
        ...
        <strong>PUBLISH THIS</strong>
		   ...
		   if(!$con)
			...
			die("sorry,we are facing a technical issue");
				 ...
				 $sql = "INSERT INTO `infotbl` (`email`, `topic`, `des`, `imagepath`, `location`, `time`, `status`, `infoID`) VALUES ('".$_SESSION["email"]."', '".$topic."', '".$des."', '".$image."', '".$location."', '".$time."', '".$status."', NULL);";
