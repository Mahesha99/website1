...
<h1><mark>INFORMATION MANAGEMENT<mark></h1>
<br>
...
<table width="1283" height="71" border="0" align="center" style="table-layout: fixed">
  <tbody>
    <tr>
    <td>&nbsp;</td>
      <td width="162">INFORMATION ID</td>
      ...
      <td>&nbsp;</td>
				...
				$sql ="SELECT * FROM `infotbl` WHERE `status` = '1' order by infoID asc ";
