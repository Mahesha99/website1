...
<h1><mark>FEEDBACK MANAGEMENT<mark></h1>
<br>
...
<table width="1283" height="30" border="0" align="center" style="table-layout: fixed;border-bottom: 2px solid #274472;">
  <tbody>
    <tr>
     <td>&nbsp;</td>
      <td width="162"><?php echo $row['id'];?></td>
      <td width="162"><?php echo $row['name'];?></td>
      <td width="162"><?php echo $row['comment'];?></td>
		<td width="162"><?php echo $row['comment_time'];?></td>
      <td width="162"><a href="feedbackdelete.php?id=<?php echo  $row['id']; ?>">delete</a></td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
</table>
