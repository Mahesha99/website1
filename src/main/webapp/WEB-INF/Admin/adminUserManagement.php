...
<h1><mark>USER MANAGEMENT<mark></h1>
<br>
...
<table width="1283" height="71" border="0" align="center" style="table-layout: fixed">
  <tbody>
    ...
    <td>&nbsp;</td>
      ...
      <td width="162">Full Name</td>
      <td width="162">Age</td>
      <td width="162">Address</td>
      <td width="162">Gender</td>
      <td width="162">Job</td>
      <td width="162">Edit</td>
      ...
      <td>&nbsp;</td>
		...
		$con = mysqli_connect("localhost","root","","newsdb");
				...
				
				{
				    ...
				    {
		  ?>
<table width="1283" height="30" border="0" align="center" style="table-layout: fixed">
  <tbody>
    <tr>
     <td>&nbsp;</td>
      <td width="162"><?php echo $row['password'];?></td>
      <td width="162"><?php echo $row['email'];?></td>
      <td width="162"><?php echo $row['fullName'];?></td>
      <td width="162"><?php echo $row['age'];?></td>
      <td width="162"><?php echo $row['address'];?></td>
      <td width="162"> <?php echo $row['gender'];?></td>
      <td width="162"><?php echo $row['job'];?></td>
      <td width="162"><a href="/news/src/main/webapp/WEB-INF/Admin/adminUpdateUser.php">edit</a></td>
      <td width="162"><a href="/news/src/main/webapp/WEB-INF/Admin/adminDeleteUsers.php">delete</a></td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
</table>
