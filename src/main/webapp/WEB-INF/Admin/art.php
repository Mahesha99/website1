...
<h1><mark>ART MANAGEMENT<mark></h1>
<br>
  ...
  <tbody>
    ...
    <td>&nbsp;</td>
      ...
      <td>&nbsp;</td>
				...
				$sql ="SELECT * FROM `arttbl` WHERE `status` = '1' order by artID asc ";
